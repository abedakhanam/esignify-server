...
//     const signingOrder = template.recipientRoles

//     // Find the current recipient's position in the signing order
//     const currentRecipientIndex = signingOrder.findIndex(
//       (role: any) => role._id.toString() === recipient
//     )

//     if (currentRecipientIndex === -1) {
//       res.status(403).json({ message: 'Recipient not part of signing order' })
//       return
//     }

//     // Filter fields to show all previous recipients' signed values as read-only
//     // and the current recipient's fields as editable
//     const visibleFields = (template.defaultFields as any[]).map(
//       (field: any) => {
//         const assignedToId = field.assignedTo?._id.toString()
//         const assignedRecipientIndex = signingOrder.findIndex(
//           (role: any) => role._id.toString() === assignedToId
//         )

//         if (assignedRecipientIndex === -1) {
//           // If no assigned recipient, skip the field
//           return null
//         }

//         // For fields of previous recipients, mark them as read-only
//         if (assignedRecipientIndex < currentRecipientIndex) {
//           return {
//             ...field.toObject(),
//             isEditable: false, // Add this property for frontend
//           }
//         }

//         // For fields of the current recipient, allow editing
//         if (assignedRecipientIndex === currentRecipientIndex) {
//           return {
//             ...field.toObject(),
//             isEditable: true, // Add this property for frontend
//           }
//         }

//         // Exclude fields for future recipients
//         return null
//       }
//     )

//     // Filter out null fields
//     const filteredFields = visibleFields.filter(Boolean)

//     // Return the template with fields including their editability status
//     res.status(200).json({
//       message: 'Template fetched successfully',
//       template: {
//         _id: template._id,
